...
export default function NewsletterSection() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className='pointer-events-none absolute inset-0 z-0 opacity-[0.03] dark:opacity-[0.03]'
        style={{
                  ...
                  <div className='grid grid-cols-1 sm:grid-cols-6 gap-3 sm:gap-4'>
                    <div className='sm:col-span-2'>
                      ...
                      <input
                        ...
                        className='w-full px-4 py-3.5 sm:py-4 rounded-xl text-[14px] outline-none transition-all duration-200 focus:ring-2 placeholder:text-neutral-400 dark:placeholder:text-white/30'
                        style={{
