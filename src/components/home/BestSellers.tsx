...
export default function BestSellers() {
    ...
    return (
        <section className='relative overflow-hidden border-y border-neutral-100'>
            <div className='absolute inset-0 bg-[#f2f2f8] transition-colors duration-400' />
            ...
            <div className='relative z-10 mx-auto max-w-300 px-7 py-16 sm:py-20'>
                ...
                >
                    <div>
                        <p className='text-[12.5px] font-semibold tracking-[0.2em] uppercase text-[#d97706] mb-3'>
                            Top Rated
                        </p>
                        <h2 className='text-[26px] sm:text-[30px] font-bold tracking-tight text-neutral-800'>
                            Best <span className='text-transparent bg-clip-text bg-linear-to-r from-[#f59e0b] to-[#d97706]'>
                                Selling Products
                            </span>
                        </h2>
                    </div>
                    <Link
                        ...
                        className='group flex items-center gap-2 text-[13px] font-semibold text-[#d97706] shrink-0 transition-colors duration-200 hover:text-[#b45309]'
                    >
                        See More
                        <ArrowUpRight
                            size={15}
                                ...
                                >
                                    <Link href={`/products/${product.slug}`}>
                                        <motion.div
                                            ...
                                            className='group relative flex items-center gap-5 sm:gap-8 py-4 sm:py-5 px-1 -mx-1 rounded-lg transition-colors duration-200 hover:bg-vc-accent/2'
                                        >
                                            {/* rank */}
                                            ...
                                            <div className='flex-1 min-w-0'>
                                                <p className='text-[11px] font-semibold tracking-wider uppercase text-neutral-400 truncate'>
                                                    {product.brand}
                                                </p>
                                                <p className='text-[15px] sm:text-[17px] font-bold leading-snug text-neutral-800 truncate transition-colors duration-200 group-hover:text-vc-accent'>
                                                    {product.name}
                                                </p>
                                            </div>
                                            ...
                                            <div className='text-right shrink-0'>
                                                <div className='flex items-baseline gap-1.5 justify-end'>
                                                    <span className='text-[17px] sm:text-[19px] font-bold text-neutral-900'>
                                                        ${product.basePrice}
                                                    </span>
