                ...
                >
                    <div>
                        ...
                        <h2 className='text-[26px] sm:text-[30px] font-bold tracking-tight text-neutral-800'>
                            Featured <span className='text-transparent bg-clip-text bg-linear-to-r from-vc-accent to-vc-accent/50'>Products</span>
                        </h2>
...
`}
                        ...
                        <div className='flex items-center justify-center gap-2 mt-4 sm:mt-6'>
                            {Array.from({ length: totalSlides }).map((_, i) => (
                                <div
                                    key={i}
                                    className={`h-1 rounded-full transition-all duration-400 ${activeDot === i ? '' : 'bg-neutral-300'
                                        }`}
                                    style={activeDot === i ? {
                                        width: 20,
                                        opacity: 1,
