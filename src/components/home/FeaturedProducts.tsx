  ...
  return (
    <section className='relative overflow-hidden border-y border-neutral-100 dark:border-white/6 bg-[#f2f2f8] dark:bg-[#08080e] transition-colors duration-400'>
      ...
      <div className='relative z-10 mx-auto max-w-300 px-7 py-16 sm:py-20'>
        ...
        >
          <div>
            <p className='text-[12.5px] font-semibold tracking-[0.2em] uppercase text-vc-accent dark:text-[#818cf8] mb-3'>
              Editor&rsquo;s pick
            </p>
            ...
            <p className='text-[13.5px] text-neutral-400 dark:text-white/35 mt-2'>
              Handpicked top gadgets for you
            </p>
          </div>
          <Link
            href='/products'
            className='group flex items-center gap-2 text-[13px] font-semibold shrink-0 transition-colors duration-200 text-vc-accent dark:text-vc-accent hover:text-[#4338ca] dark:hover:text-[#4f46e5]'
          >
            View All
            <ArrowUpRight
              size={15}
        ...
        <div className='flex items-center gap-4 mb-8'>
          <div className='flex-1 h-px bg-linear-to-r from-transparent via-vc-accent/20 dark:via-[#818cf8]/20 to-transparent' />
          <div className='size-1.5 rounded-full bg-vc-accent/30 dark:bg-[#818cf8]/30' />
          <div className='flex-1 h-px bg-linear-to-r from-transparent via-vc-accent/20 dark:via-[#818cf8]/20 to-transparent' />
        </div>
        ...
        {isLoading ? (
          ...
          <div className='relative'>
            ...
            <button
              onClick={() => scroll('left')}
              className='absolute -left-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white dark:bg-[#1c1c2a] border border-neutral-200 dark:border-white/8 shadow-lg hidden items-center justify-center text-neutral-600 dark:text-white/60 hover:text-vc-accent dark:hover:text-[#818cf8] transition-all duration-200 hover:scale-105 active:scale-95 sm:flex'
            ...
            <button
              ...
              className='absolute -right-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full bg-white dark:bg-[#1c1c2a] border border-neutral-200 dark:border-white/8 shadow-lg hidden items-center justify-center text-neutral-600 dark:text-white/60 hover:text-vc-accent dark:hover:text-[#818cf8] transition-all duration-200 hover:scale-105 active:scale-95 sm:flex'
            ...
            <div className='relative transition-opacity duration-300'>
              {/* shelf shadow */}
              <div className='absolute bottom-0 inset-x-4 h-6 bg-linear-to-t from-black/4 dark:from-white/3 to-transparent rounded-b-2xl pointer-events-none' />
                  ...
                  >
                    <Link href={`/products/${hero.slug}`}>
                      <motion.div
                        ...
                        className='group relative h-[500px] sm:h-[480px] rounded-2xl overflow-hidden border border-neutral-100 dark:border-white/6 bg-white dark:bg-[#0c0a14] transition-shadow duration-300 motion-reduce:transition-none hover:[box-shadow:0_12px_48px_color-mix(in_srgb,#6366f1_14%,transparent)] motion-reduce:hover:[box-shadow:none]!'
                      >
                        {hero.variants[0]?.images[0] ? (
                          ...
                          <div className='flex h-full items-center justify-center text-neutral-300 dark:text-white/15 text-sm'>
                            No Image
                          </div>
                        )}
                        ...
                        <div className='absolute top-4 left-4 z-10 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/90 dark:bg-[#1c1c2a]/90 backdrop-blur-sm border border-white/20 dark:border-white/6 text-[11px] font-bold text-vc-accent dark:text-[#818cf8] shadow-sm'>
                        ...
                        <button
                          ...
                          className={`
                            ...
                            bg-white/90 dark:bg-[#1c1c2a]/90 backdrop-blur-sm
                            ${isInWishlist(hero._id)
                              ? 'text-red-500'
                              : 'text-neutral-400 dark:text-white/40 hover:text-red-400'}
                          `}
                    ...
                    >
                      <Link href={`/products/${product.slug}`}>
                        <motion.div
                          ...
                          className='group relative h-105 sm:h-120 rounded-2xl overflow-hidden bg-white dark:bg-[#0c0a14] border border-neutral-100 dark:border-white/6 transition-shadow duration-300 motion-reduce:transition-none hover:[box-shadow:0_8px_32px_color-mix(in_srgb,#6366f1_10%,transparent)] motion-reduce:hover:[box-shadow:none]!'
                        >
                          {img ? (
                            <Image
                              src={img}
                          ...
                          <button
                            ...
                            className='absolute top-3 right-3 z-10 w-8 h-8 rounded-full bg-white/90 dark:bg-[#1c1c2a]/90 backdrop-blur-sm shadow-md flex items-center justify-center text-neutral-600 dark:text-white/60 hover:text-vc-accent dark:hover:text-[#818cf8] transition-all duration-200 hover:scale-105 active:scale-90'
              ...
              {Array.from({ length: totalSlides }).map((_, i) => (
                <div
                  ...
                  className={`h-1 rounded-full transition-all duration-400 ${
                    activeDot === i ? '' : 'bg-neutral-300 dark:bg-white/15'
                  }`}
                  style={activeDot === i ? {
                    width: 20,
                    opacity: 1,
