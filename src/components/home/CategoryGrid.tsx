...
export default function CategoryGrid() {
  return (
    <section className='relative overflow-hidden border-y border-neutral-100 dark:border-white/6 transition-colors duration-400' style={{ background: 'var(--bg)' } as React.CSSProperties}>
      ...
      <div className='relative z-10 mx-auto max-w-300 px-7 py-16 sm:py-20'>
        ...
        >
          <p className='text-[12.5px] font-semibold tracking-[0.2em] uppercase text-vc-accent dark:text-[#a5b4fc] mb-3'>
            Categories
          </p>
          <h2 className='text-[26px] sm:text-[30px] font-bold tracking-tight text-neutral-900 dark:text-white'>
            Shop by{' '}
            <span style={{ color: 'var(--accent)' }}>
              Category
            </span>
          </h2>
          <p className='text-[13.5px] text-neutral-500 dark:text-white/50 mt-2 max-w-md mx-auto'>
        ...
        <div className='flex items-center gap-4 mt-8 sm:mt-10 mb-8 sm:mb-10'>
          <div className='flex-1 h-px bg-linear-to-r from-transparent via-vcaccent/20 dark:via-[#818cf8]/20 to-transparent' />
              ...
              >
                <Link href={`/products?category=${cat.slug}`}>
                  <motion.div
                    whileHover={{ y: -4 }}
                    whileTap={{ scale: 0.98 }}
                    className='relative h-full rounded-2xl border border-neutral-100 dark:border-white/6 bg-white dark:bg-[#0c0a14] overflow-hidden transition-shadow duration-300 motion-reduce:transition-none hover:[box-shadow:0_8px_40px_color-mix(in_srgb,var(--c1)_10%,transparent),inset_0_0_0_1px_color-mix(in_srgb,var(--c1)_18%,transparent)] motion-reduce:hover:[box-shadow:none]!'
                  ...
                  >
                    ...
                    <div className='relative p-5 sm:p-6 pl-7 sm:pl-8 flex flex-col h-full min-h-45'>
                      ...
                      <div className='flex-1'>
                        <h3 className='text-[15px] font-bold text-neutral-800 dark:text-white/90 transition-colors duration-200 group-hover:text-(--c1) dark:group-hover:text-(--c2) motion-reduce:transition-none'>
                          {cat.name}
                        </h3>
                        <p className='text-[12.5px] text-neutral-400 dark:text-white/35 mt-1.5 leading-relaxed line-clamp-2'>
                          {cat.desc}
                        </p>
                      </div>
                    ...
                    <div
                      className='absolute -bottom-4 -right-4 size-16 rounded-full opacity-[0.04] dark:opacity-[0.07] transition-all duration-500 group-hover:scale-[2] group-hover:opacity-[0.06] dark:group-hover:opacity-[0.1] motion-reduce:transition-none motion-reduce:scale-100 motion-reduce:opacity-[0.04] pointer-events-none'
                      style={{
