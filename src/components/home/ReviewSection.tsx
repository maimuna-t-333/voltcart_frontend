  ...
  return (
    ...
    >
      ...
      <Quote
        size={36}
        strokeWidth={1}
        className='absolute top-3 right-3 opacity-[0.06] dark:opacity-[0.08] text-neutral-900 dark:text-white pointer-events-none'
      />

      {/* top-right flourish */}
      <div
        className='absolute -top-4 -right-4 size-16 rounded-full opacity-[0.04] dark:opacity-[0.07] transition-all duration-500 group-hover:scale-[2] group-hover:opacity-[0.06] dark:group-hover:opacity-[0.1] pointer-events-none'
        style={{
        ...
        <div className='flex items-center gap-0.5'>
          {Array.from({ length: 5 }).map((_, j) => (
            <Star
              ...
              size={13}
              strokeWidth={1.5}
              className={j < review.rating ? 'fill-amber-400 text-amber-400' : 'text-neutral-300 dark:text-white/10'}
            />
          ))}
        </div>
    ...
    <section className='relative overflow-hidden border-y border-neutral-100 dark:border-white/6 transition-colors duration-400' style={{ background: 'var(--bg)' } as React.CSSProperties}>
      ...
      <div className='relative z-10 mx-auto max-w-300 px-7 py-16 sm:py-20'>
        ...
        <div className='flex items-center gap-4 mt-8 sm:mt-10 mb-8 sm:mb-10'>
          <div className='flex-1 h-px bg-linear-to-r from-transparent via-[#6366f1]/20 dark:via-[#818cf8]/20 to-transparent' />
