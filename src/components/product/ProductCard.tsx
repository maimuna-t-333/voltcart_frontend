        ...
        <div className='absolute top-3 right-3 z-10 flex gap-1.5'>
          ...
          <button onClick={handleAddToCart}
            className='w-8 h-8 rounded-full flex items-center justify-center shadow-md transition-all duration-200
              ...
              text-neutral-600 dark:text-white/60 hover:text-[#6366f1] dark:hover:text-[#818cf8] hover:scale-105 active:scale-90'
          ...
          <button onClick={handleWishlist}
            className={`w-8 h-8 rounded-full flex items-center justify-center shadow-md transition-all duration-200
              bg-white/90 dark:bg-[#1c1c2a]/90 backdrop-blur-sm
              ${wishlisted ? 'text-red-500' : 'text-neutral-400 dark:text-white/40 hover:text-red-400'}`}
            aria-label='Wishlist'>
